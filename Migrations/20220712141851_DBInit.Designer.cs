...
namespace TasteonusAPI.Migrations
{
    ...
    [Migration("20220712141851_DBInit")]
            ...
            modelBuilder.Entity("TasteonusAPI.Models.Feedback", b =>
                {
                    b.HasOne("TasteonusAPI.Models.User", "User")
                        .WithOne("Feedback")
                        .HasForeignKey("TasteonusAPI.Models.Feedback", "user_fb")
            ...
            modelBuilder.Entity("TasteonusAPI.Models.Recipe", b =>
                {
                    b.HasOne("TasteonusAPI.Models.User", "User")
                        .WithOne("Recipe")
                        .HasForeignKey("TasteonusAPI.Models.Recipe", "user_rec")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
